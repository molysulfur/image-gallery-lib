...
class HorizontalAdapterViewHolder constructor(private val view: View) : RecyclerView.ViewHolder(view) {

    fun bind(imageAdapter: ImageGalleryAdapter?, item: ImageGalleryItem.HorizontalAdapterItem) {
